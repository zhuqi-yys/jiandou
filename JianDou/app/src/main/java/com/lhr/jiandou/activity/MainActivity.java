...
import com.lhr.jiandou.BugHunter.ScreenShotListenManager;
...
public class MainActivity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            final com.lhr.jiandou.BugHunter.FloatingActionButton button = new com.lhr.jiandou.BugHunter.FloatingActionButton(this);
            ScreenShotListenManager manager = ScreenShotListenManager.newInstance(this);
            //set listeners
            manager.setListener(
                    new ScreenShotListenManager.OnScreenShotListener() {
                        public void onShot(String imagePath) {
                            button.camera(com.lhr.jiandou.BugHunter.FloatingActionButton.getCurrentActivity());
                        }
                    }
            );
            manager.startListen();
        } catch (Exception e) {
            Log.e("BugHunter", "Floating Button fails to initialize");
            e.printStackTrace();
        }
